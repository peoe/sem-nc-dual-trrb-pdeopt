...
% abstract
\begin{abstract}
    Reduced basis methods are a relatively new approach to make multi-query scenarios for parametric partial differential equations (PDEs) with a large amount of parameters feasible.
