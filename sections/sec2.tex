...
The general procedure according to~\cite[Section 3.3]{Kelley1999} is to approximate the objective function by a quadratic model function in a region where we can trust that this approximation is of sufficient quality --- the so-called \textbf{trust-region}.

\todoinline{Write paragraph on TR in the paper, i.e.~model function via solution functional!}

\todoinline{Write paragraph about BFGS in conjunction with TRM!}