...
The general procedure according to~\cite[Section 3.3]{Kelley1999} is to approximate the objective function by a model function $m_k$ in a region where we can trust that this approximation is of sufficient quality --- the so-called \textbf{trust-region}.
...
For this matter we involve the BFGS method (Broyden, Fletcher, Goldfarb, Shanno) which is a quasi-Newton method, where we perform a line search with some approximation of the Hessian for the Newton steps, cf.~\cite[Chapter 4]{Kelley1999}.
