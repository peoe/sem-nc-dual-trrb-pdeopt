...
\begin{frame}{Optimality Conditions --- NCD-Corrected Approach}
    ...
    \only<4>{
        % todo: add inexact ncd gradient! mention inexact sensitivities, corresponding residuals, and their error estimators -- keep it vague though!
        qet
    }
\end{frame}
...
\begin{frame}{\textit{a posteriori} Error Estimates}
    ...
    \only<4>{
        % todo: think about going into detail of this computation!
        qweradg
    }
\end{frame}