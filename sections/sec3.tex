...
\todoinline{Add the proof of this to the appendix!!!}
...
As~\cite{Keil2021} does, we also want to emphasize that most of these results can only be computed efficiently by means of the offline/online decomposition.