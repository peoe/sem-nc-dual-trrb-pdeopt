...
In analogy to Proposition~\ref{NCDGradientSensProp} we define the \textbf{approximate partial derivatives} as the solutions to
\begin{align*}
...
The gradient for the approximate sensitivities is defined componentwise as
\begin{align*}
