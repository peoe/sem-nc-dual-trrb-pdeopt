    ...
    \only<2, 3, 4, 5>{
        \begin{block}{Assumptions, c.f.~\cite{Banholzer2020}}
            \begin{itemize}
                ...
                \item For every TR iteration $k$ we can find a trust-radius large enough for which the decrease condition is satisfied.
                \only<3>{\item \color{red} The gradient $\nabla \mathcal{J}_N^{(k)}$ is uniformly Lipschitz continuous on $\mathcal{P}$. The second order derivatives are locally Lipschitz continuous.}
                \only<4>{
                    \item The gradient $\nabla \mathcal{J}_N^{(k)}$ is uniformly Lipschitz continuous on $\mathcal{P}$. The second order derivatives are locally Lipschitz continuous.
                    \item \color{red} The function $q^{(k)}$ is uniformly continuous in $\mathcal{P}$, uniformly in $k$.
                }
                \only<5>{
                    \item The gradient $\nabla \mathcal{J}_N^{(k)}$ is uniformly Lipschitz continuous on $\mathcal{P}$. The second order derivatives are locally Lipschitz continuous.
                    \item The function $q^{(k)}$ is uniformly continuous in $\mathcal{P}$, uniformly in $k$.
                }
            \end{itemize}
        \end{block}
    }
