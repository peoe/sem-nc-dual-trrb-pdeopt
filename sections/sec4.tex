...
\begin{algorithm}[H]\label{alg:AdaptTRRB}
    ...
    \While{$loop\_flag$}{
        ...
        \If{$\mathcal{J}_N^{(k)}(\mu^{(k + 1)}) + \Delta_{\mathcal{J}_N^{(k)}}(\mu^{(k + 1)}) < \mathcal{J}_N^{(k)}(\mu^{(k)})$}{
        ...
        \ElseIf{$\mathcal{J}_N^{(k)}(\mu^{(k + 1)}) + \Delta_{\mathcal{J}_N^{(k)}}(\mu^{(k + 1)}) > \mathcal{J}_N^{(k)}(\mu^{(k)})$}{
        ...
        \Else{
            ...
            \If{$\mathcal{J}_N^{(k + 1)}(\mu^{(k + 1)}) \leq \mathcal{J}_N^{(k)}(\mu^{(k)})$}{
                Accept $\mu^{(k + 1)}$\;
                \If{$\rho^{(k)} \geq \eta$}{
                    Enlarge the radius\;
                }
